          ...
          <div className="news-grid">
            ...
            <div className="news-card">
              <div className="news-image">
                <img src={ONPG_IMAGES.news1} alt="Actualité 1" />
            ...
            <div className="news-card">
              <div className="news-image">
                <img src={ONPG_IMAGES.news2} alt="Actualité 2" />
            ...
            <div className="news-card">
              <div className="news-image">
                <img src={ONPG_IMAGES.news3} alt="Actualité 3" />
        ...
        <div className="container">
          <div className="formation-content">
            ...
            <div className="formation-image">
              <img src={ONPG_IMAGES.formation} alt="Formation Continue ONPG" />
            </div>
          </div>
        </div>
      </section>
