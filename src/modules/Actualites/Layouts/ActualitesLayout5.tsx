...
// Layout 5 : Inspiré de Framer Blog - Créatif, visuel, animations fluides
const ActualitesLayout5 = () => {
    ...
    <div className="framer-layout">
      <header className="framer-header">
        <div className="container">
          <h1>Actualités</h1>
          <p className="framer-subtitle">Découvrez nos dernières actualités</p>
          <div className="framer-search-wrapper">
            <input
              type="text"
      ...
      <section className="framer-filters">
        <div className="container">
          <div className="framer-filters-inner">
            <div className="framer-categories">
              {categories.map(cat => (
                <button
                  key={cat.id}
                  type="button"
                  className={`framer-category-btn ${selectedCategory === cat.id ? 'active' : ''}`}
          ...
          {allTags.length > 0 && (
            <div className="framer-tags">
              {allTags.slice(0, 10).map(tag => (
                <button
                  key={tag}
                  type="button"
                  className={`framer-tag ${selectedTag === tag ? 'active' : ''}`}
      ...
      <section className="framer-articles">
        <div className="container">
          {loading ? (
              ...
              {filteredArticles.map(article => (
                ...
                >
                  {article.featuredImage && (
                    <div className="framer-card-image">
                      <img src={article.featuredImage} alt={article.title} />
                    </div>
                  )}
                  <div className="framer-card-content">
                    <div className="framer-card-badge">
...
export default ActualitesLayout5;
